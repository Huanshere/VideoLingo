...
对于本地运行，本项目提供了一键简易包和源码安装两种方式，请根据需要选择。

[English](./docs/pages/docs/start.en-US.md) | [简体中文](./docs/pages/docs/start.zh-CN.md)

## 🏭 批量模式

[English](./batch/README.md) | [简体中文](./batch/README.zh.md)
