...
def page_setting():
    ...
    with st.expander(t("Dubbing Settings"), expanded=True):
        tts_methods = ["azure_tts", "openai_tts", "fish_tts", "sf_fish_tts", "edge_tts", "gpt_sovits", "sf_cosyvoice2", "f5tts", "minimax_tts", "custom_tts"]
        ...
        if select_tts == "sf_fish_tts":
            ...
            config_input("Replicate Token", "minimax.replicate_token")
