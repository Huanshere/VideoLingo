...
def get_summary():
    ...
    print(f"📝 Summarizing... Please wait a moment...")
    summary = ask_gpt(summary_prompt, model=step4_1_summarize_model, response_json=True, valid_key='terms', log_title='summary')
