...
- TTS: Azure, OpenAI, Fish TTS, SiliconFlow Fish/CosyVoice2, GPT-SoVITS, Edge TTS, F5-TTS, ModelBest VoxCPM, and a custom adapter in `core/tts_backend/custom_tts.py`.
